...
POPLAR_ENGINE_OPTIONS='{"autoReport.all":"true","autoReport.directory":"./reports_layer/sparse_layer_06_weightsGradVecSingleThread_manVec_twoNeuron_memConstraint"}' python3 train_random.py --use_ipu=1 --impl_method=sparse_layer --profile_run=1 --transpose_weights=1
