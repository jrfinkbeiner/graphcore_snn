...
POPLAR_ENGINE_OPTIONS='{"autoReport.all":"true","autoReport.directory":"./reports_multiIpu/execAnalysis_2ipu_4_manuallyCopyInppSpikesToTiles"}' python3 multi_ipu.py
